...
- E2E specs: `apps/web/e2e/` (package/config root: `apps/web/`; config: `apps/web/playwright.config.ts`)
...
- E2E: `pnpm test:e2e` (run `pnpm --filter @supervision-sports-highlights/web exec playwright install chromium` once first)
